...
El mercado actual ofrece una amplia variedad de plataformas orientadas a la creación de tiendas online sin necesidad de conocimientos de programación. A continuación se analizan las soluciones más representativas:
...
Los tres frameworks permiten crear aplicaciones modernas, pero Angular ofrece la solución más completa desde el inicio: tipado estricto con TypeScript, herramientas integradas de enrutamiento, gestión de formularios reactivos y soporte oficial de Google, lo que lo convierte en la opción más adecuada para proyectos de mediana y gran escala. Por todo ello, para este TFG se ha optado por Angular. Cabe añadir, de forma adicional, que es la tecnología empleada en Capgemini, empresa en la que se van a realizar las prácticas, lo que ha permitido adquirir una base sólida en el framework a través de cursos de formación previos a la incorporación al entorno profesional.
...
\subsubsection{Comparación y elección}
Spring Boot, Node.js y Django son alternativas viables para el desarrollo de un backend. Node.js destaca por su rapidez en tiempo real y Django por la simplicidad de Python, pero para este TFG se ha optado por Spring Boot por su robustez, su madurez en entornos empresariales, su integración nativa con MySQL mediante JPA y su capacidad para complementar de forma óptima la arquitectura planteada con Angular. Además, ofrece soporte transaccional completo, mecanismos de seguridad avanzados y un ecosistema estable respaldado por VMware. De forma adicional, cabe señalar que Spring Boot es la tecnología utilizada en Capgemini, empresa en la que se realizarán las prácticas, lo que ha permitido formarse previamente mediante cursos y adquirir los conceptos básicos necesarios para afrontar ese entorno profesional.
...
\textbf{Ventajas:}
\begin{itemize}
    \item Integridad referencial garantizada mediante claves primarias y foráneas.
    \item Lenguaje SQL estándar, ampliamente adoptado en entornos empresariales.
    \item Soporte transaccional completo (ACID).
    \item Alta consistencia y fiabilidad de los datos.
\end{itemize}

\textbf{Desventajas:}
\begin{itemize}
    \item Menor flexibilidad frente a estructuras de datos cambiantes.
    \item Escalabilidad horizontal más limitada que las alternativas NoSQL.
    \item Requiere definir el esquema de datos con antelación.
    \item Puede resultar menos eficiente para grandes volúmenes de datos no estructurados.
\end{itemize}

\subsubsection{NoSQL}
Las bases de datos NoSQL, como MongoDB, almacenan la información en estructuras más flexibles, como documentos o grafos \cite{mongodbDocs}. Ofrecen mayor escalabilidad y rapidez en ciertas operaciones, aunque sacrifican consistencia y mecanismos de control más avanzados.

\textbf{Ventajas:}
\begin{itemize}
    \item Alta escalabilidad horizontal, adecuada para grandes volúmenes de datos.
    \item Mayor flexibilidad en el modelo de datos, sin esquema fijo.
    \item Buen rendimiento en operaciones de lectura y escritura masivas.
    \item Idóneas para datos no estructurados o semiestructurados.
\end{itemize}

\textbf{Desventajas:}
\begin{itemize}
    \item Menor consistencia en comparación con las bases de datos relacionales.
    \item Ausencia de un lenguaje de consulta estándar.
    \item Soporte limitado para transacciones complejas.
    \item Mecanismos de seguridad y control de acceso menos maduros.
\end{itemize}
