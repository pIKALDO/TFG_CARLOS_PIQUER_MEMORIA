...
\begin{itemize}
    ...
    \item \textbf{Falta de experiencia con el bot de Telegram:} se dedicará tiempo a aprender el funcionamiento de la librería antes de integrarlo por completo. Se probarán ejemplos sencillos para entender cómo gestionar comandos y notificaciones, y se consultará la documentación cuando sea necesario.
\end{itemize}
