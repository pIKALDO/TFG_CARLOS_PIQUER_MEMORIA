...
\begin{resum}
Aquest treball descriu el desenvolupament d{'}una botiga en l{\'\i}nia completa per a la Drogueria Merceria Inés, un negoci familiar ubicat a València. La solució implementa el flux complet de comerç electrònic: registre i autenticació d{'}usuaris, catàleg de productes amb filtres i cercador, gestió del carret, pagaments segurs mitjançant la passarel·la \textit{Stripe} i generació automàtica de factures en PDF. El sistema incorpora també un panell d{'}administració per a la gestió de l{'}inventari i el seguiment de les comandes, així com un \textit{bot de Telegram} que automatitza les notificacions de confirmació de compra i els avisos de baix estoc.
...
En primer lugar, quería agradecer a mis amigos, porque son los que me dan alegría día a día. Gracias por estar siempre ahí, desde que tengo uso de razón; en las buenas, en las malas y en mis peores momentos, siempre me habéis levantado. No hay etapa de mi vida en la que no estéis presentes, especialmente desde aquellos años a los tres añitos en Campanilla. Gracias por todo lo que nos queda por compartir y por seguir cerrando etapas juntos.

A toda mi familia. Gracias por estar siempre a mi lado, en los momentos buenos pero sobre todo en los malos. Miro a mi alrededor y sé que, pase lo que pase, siempre vais a estar ahí para lo que necesite. Si de algo estoy orgulloso en esta vida, es de la gran suerte que tengo de formar parte de esta familia.

A Carmen. Gracias por ser mi refugio y mi mayor apoyo, por conocerme mejor que nadie y darme fuerzas para que no me viniera abajo. Por animarme cada día a ser mejor y por acompañarme en mis decisiones. Dicen que coincidir es suerte, pero conectar como lo hemos hecho nosotros es algo único. Gracias por ser mi copiloto en toda esta etapa.

Y por último a mi madre, la persona que ha confiado en mí desde el día cero. Gracias por dejarte la vida y luchar incansablemente para que hoy sea la persona que soy; siempre te estaré agradecido por todo lo que has hecho por mí, mami. Aunque en este viaje me haya faltado una persona, sé que tú vales por dos y que nunca me has soltado de la mano.

Y a ti, papá. Sé que te fuiste cuando era muy pequeño, pero has sido mi motor en la distancia. Gracias por ser esa estrella que nos ilumina desde arriba siempre. Sé que estarías orgulloso.
\end{agradecimientos}
\cleardoublepage
