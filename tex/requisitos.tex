...
\begin{itemize}
    \item \textbf{Perfil 1 — Estudiante avanzado:} estudiante de último curso del Grado en Ingeniería Informática, con experiencia en proyectos académicos y conocimientos de programación web. Su visión ayudó a estimar el esfuerzo que supone desarrollar un proyecto individual de este tipo.

    \item \textbf{Perfil 2 — Desarrollador junior:} profesional con unos dos años de experiencia en el desarrollo de aplicaciones web. Sus aportaciones permitieron ajustar los tiempos de las fases de codificación y pruebas basándose en su experiencia práctica reciente.

    \item \textbf{Perfil 3 — Desarrollador senior / jefe de proyecto:} profesional con más de cinco años de experiencia en la gestión y supervisión de proyectos informáticos. Su punto de vista ayudó a validar la coherencia general del calendario y la estimación global del esfuerzo.
\end{itemize}

El contraste de opiniones entre estos perfiles permitió confirmar que las estimaciones iniciales eran adecuadas y que la planificación final se ajusta razonablemente a la complejidad y alcance del proyecto.
...
\hline
\textbf{Total estimado del proyecto} & & \textbf{4.100 €} \\
\hline
\end{tabular}
...
comparando los valores calculados con estimaciones de proyectos similares y con referencias salariales obtenidas de portales como Indeed. 
